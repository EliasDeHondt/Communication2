...
<html lang="nl">
    <head>
        <!--Meta + Title-->
        <meta charset="utf-8">
        <title>BierBrigade - Vlog 4</title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta property="og:title" content="BierBrigade - Vlog 4" />
        <meta property="og:image" content="https://eliasdh.com/assets/media/images/logo-hd.png"/>
        <meta content="BierBrigade - Vlog 4" name="description">
        <!--Meta + Title-->
        <!--Favicon-->
    ...
    <body class="selectioncoler" data-spy="scroll" data-target=".navbar" data-offset="51">
        ...
        <div class="container">
            ...
            <br>
            <br>
            <h1>Vlog 4 - Preparation sprint 1 Axel</h1>
            <!--YouTube-video-->
            <div class="youtube-video">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/akMW4yTNEWs" frameborder="0" allowfullscreen></iframe>
            </div>
            <!--YouTube-video-->
            <!--Comments Section-->
